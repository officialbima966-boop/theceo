...
-- Create site_settings table to store configuration
...
-- Policy: anyone can read settings (for CTA buttons)
...
INSERT INTO public.site_settings (key, value) VALUES ('whatsapp_number', '628123456789');
